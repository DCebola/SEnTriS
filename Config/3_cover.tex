...
%-------------------------------------------------------------------
\nttitle(main,en){Privacy-Enhanced Ontologies}%
\nttitle(main,pt){Privacy-Enhanced Ontologies}%
...
%         You may use "\\" to force line breaks
%-------------------------------------------------------------------
\nttitle(sub,en){A Practical SSE M/M Framework}%
\nttitle(sub,pt){Uma Framework de SSE Prática para o Modelo M/M}%
