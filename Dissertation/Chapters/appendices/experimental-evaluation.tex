...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Figures/chapter5/lubm/soundness_completeness_lubm-1_v1.png}
    \caption{Soundness and correctness, for lubm(1) (\gls{SEnTriS} V1).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Figures/chapter5/lubm/soundness_completeness_lubm-1_v2.png}
