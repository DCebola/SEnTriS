...
\begin{description}
    ...
    For the second protocol we developed a novel equality join, which operates over non-deterministic values, which we denominate \emph{equality tags}. These values are encrypted using the \gls{DGK} cryptosystem \autocite{Damgard2007-km, Damgard2009-my, Franz2011-sm, Makkes2010-qb}, an additive homomorphic scheme developed for secure integer comparison. 
\end{description}
