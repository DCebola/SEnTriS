...
\mytodo{Revise cloud adoption values to 2023 landscape}
...
Besides \gls{HE} and \gls{SE}, \gls{ORAM} \autocite{Goldreich1996-yb} could theoretically be used as an alternative. However, \gls{ORAM} and \gls{HE} continue to be too inefficient for  real world applications, when considered as an exclusive solution \autocite{Bosch2014-eb}. Furthermore, \gls{SSE} is often more practical than \gls{PEKS}, as asymmetric cryptographic schemes tend to be more efficient than their symmetric counterparts \autocite{Pearson2017-ve}. 
...
\mytodo{Briefly mention existing solutions and their trade-off} 
\mytodo{Topology leakage, missing write operation, and lack of persistence.}
...
\mytodo{SSE is the most practical approach why a secure solution}
\mytodo{OWL2 but for RDF, RDFS makes sense}
