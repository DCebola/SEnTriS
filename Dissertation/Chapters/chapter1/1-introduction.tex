...
\begin{description}
    ...
    \gls{SEnTri} is a searchable encrypted triplestore that can evaluate secure SPARQL read and write queries, possesses reasoning capabilities and supports role based access control.
