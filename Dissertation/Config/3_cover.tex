...
%-------------------------------------------------------------------
\nttitle(main,en){SEnTri: A Searchable Encrypted Triplestore for Semantic Data}%
\nttitle(main,pt){SEnTri: Uma Triplestore Encriptada para Dados Semânticos}%
...
%         You may use "\\" to force line breaks
%-------------------------------------------------------------------
\nttitle(sub,en){Developing protocols to secure expressive SPARQL queries over encrypted semantic data}%
\nttitle(sub,pt){Desenvolvendo protoclos para proteger a avalição de queries SPARQL expressivas sobre dados semânticos encriptados}
%         You may use "\\" to force line breaks
% \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
