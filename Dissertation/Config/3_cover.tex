...
%-------------------------------------------------------------------
\nttitle(main,en){SEnTriS: A Searchable Encrypted Triplestore Sharing Protocol}%
\nttitle(main,pt){SEnTriS: Um protocolo para a distribuição de Triplestores Encriptadas Pesquisáveis}%
...
%         You may use "\\" to force line breaks
%-------------------------------------------------------------------
\nttitle(sub,en){A practical and secure solution for the collaborative development, and distribution, of semantic data knowledge bases}%
\nttitle(sub,pt){Uma solução prática e segura para o desenvolvimento colaborativo, e distribuição, de fontes de conhecimento semânticas}
%         You may use "\\" to force line breaks
% \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
...
% Co-advisers(s)
\ntaddperson{adviser}(a,m){João Leitão, Associate Professor, NOVA University Lisbon}
