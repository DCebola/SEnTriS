...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Matthias Knorr, Assistant Professor, NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(a,m){João Leitão, Assistant Professor, NOVA University Lisbon}
