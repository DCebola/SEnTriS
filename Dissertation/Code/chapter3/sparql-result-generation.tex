...
function generateFinalResult($triplestoreID$, $queryType$, $sparqlResult$, $construct$, $upload$, $delete$)
    if $queryType$ == "SELECT":
        return generateSELECTResults(plan.getVars(), sparqlResult)
    elif $queryType$ == "CONSTRUCT":
        return generateCONSTRUCTResults(planner.getConstructTemplate(), sparqlResult)
    elif $queryType$ == "ASK":
        return generateASKResults(sparqlResult)
    elif $queryType$ == "DESCRIBE":
        return generateDESCRIBEResults(plan.getVars(), sparqlResult)
    else:
