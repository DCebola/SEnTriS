...
public class IAMClient {
    ...
    public static CloseableHttpResponse hasReadAccess(HttpClient httpClient, Cookie cookie, String triplestoreID, String accessToken) throws IOException {
        return HTTPUtils.sendGETRequest(httpClient, cookie, String.format(CHECK_TRIPLESTORE_READ_ACCESS_URI, triplestoreID), accessToken);
    }
    ...
    public static CloseableHttpResponse hasWriteAccess(HttpClient httpClient, Cookie cookie, String triplestoreID, String accessToken) throws IOException {
        return HTTPUtils.sendGETRequest(httpClient, cookie, String.format(CHECK_TRIPLESTORE_WRITE_ACCESS_URI, triplestoreID), accessToken);
    }
    ...
    public static CloseableHttpResponse hasOwnerAccess(HttpClient httpClient, Cookie cookie, String triplestoreID, String accessToken) throws IOException {
        return HTTPUtils.sendGETRequest(httpClient, cookie, String.format(CHECK_TRIPLESTORE_OWNER_ACCESS_URI, triplestoreID), accessToken);
    }
}
