...
public class TriplestoreClient {
    ...
    public static CloseableHttpResponse upload(Cookie cookie, String storeID, List<Triple> triples, String accessToken) throws IOException {
        return HttpUtils.sendPOSTRequest(cookie, String.format(UPLOAD_URI, storeID), ClientUtils.objectToHttpEntity(triples), accessToken);
    }
    ...
    public static CloseableHttpResponse deleteSome(Cookie cookie, String storeID, List<Triple> triples, String accessToken) throws IOException {
        return HttpUtils.sendPOSTRequest(cookie, String.format(DELETE_SOME_URI, storeID), ClientUtils.objectToHttpEntity(triples), accessToken);
    }
