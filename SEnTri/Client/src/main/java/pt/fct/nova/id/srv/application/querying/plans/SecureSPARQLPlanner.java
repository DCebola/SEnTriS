...
import pt.fct.nova.id.srv.application.querying.jobs.jobs1.*;
import pt.fct.nova.id.srv.application.querying.jobs.jobs2.JoinJob;
import pt.fct.nova.id.srv.application.querying.jobs.jobs2.MinusJob;
import pt.fct.nova.id.srv.application.querying.jobs.jobs2.OptionalJob;
import pt.fct.nova.id.srv.application.querying.jobs.jobs2.UnionJob;
import pt.fct.nova.id.srv.presentation.controllers.ParsingUtils;

import java.util.*;

import static pt.fct.nova.id.srv.application.querying.QueryUtils.*;
import static pt.fct.nova.id.srv.application.querying.QueryUtils.generateID;
