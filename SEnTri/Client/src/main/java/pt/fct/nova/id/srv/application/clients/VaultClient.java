...
public class VaultClient {
    ...
    public static CloseableHttpResponse saveProtocolSecrets(Cookie cookie, String triplestoreID, Map<String, String> secrets, String accessToken) throws IOException {
    ...
    public static CloseableHttpResponse getProtocolSecrets(Cookie cookie, String triplestoreID, String accessToken) throws IOException {
        return HTTPUtils.sendGETRequest(cookie, String.format(GET_SECRETS_URI, triplestoreID), accessToken);
    }

    public static CloseableHttpResponse deleteProtocolSecrets(Cookie cookie, String triplestoreID, String accessToken) throws IOException {
