...
public class IAMClient {
    ...
    public static CloseableHttpResponse hasReadAccess(Cookie cookie, String triplestoreID, String accessToken) throws IOException {
        return sendGETRequest(cookie, String.format(IAM_PROVIDER_CHECK_STORE_READ_ACCESS_URI, triplestoreID), accessToken);
    }
    ...
    public static CloseableHttpResponse hasWriteAccess(Cookie cookie, String triplestoreID, String accessToken) throws IOException {
        System.out.printf((IAM_PROVIDER_CHECK_STORE_WRITE_ACCESS_URI) + "%n", triplestoreID);
        return sendGETRequest(cookie, String.format(IAM_PROVIDER_CHECK_STORE_WRITE_ACCESS_URI, triplestoreID), accessToken);
    }
