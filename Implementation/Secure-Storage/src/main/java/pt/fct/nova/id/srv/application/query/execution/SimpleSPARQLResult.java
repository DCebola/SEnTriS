...
public class SimpleSPARQLResult implements SPARQLResult {
    ...
    public SimpleSPARQLResult(List<SortCondition> sortConditions, boolean isDistinct, boolean isOrdered, boolean isSliced, Long offset, Long length) {
