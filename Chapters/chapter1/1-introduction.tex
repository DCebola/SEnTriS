...
\mycomment{Diogo}{A concept is mapped to a unique identifier, and meaning is encoded in sets of triples, each triple consisting of a subject, verb and object (similar to an elementary sentence).
