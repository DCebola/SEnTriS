...
public class SecureSPARQLPlanner extends OpVisitorByType implements SPARQLPlanner {
        ...
        if (restriction != null) {
            if (restriction.isHasValueRestriction()) {
                ...
                join = pushJoin(
                        ...
                        expandProperty(prefix.concat(" PROPERTY"), right, s, property, var, depth + 1, jobs, jobsIDs, true, true), jobs, jobsIDs);
    ...
    private static void generateAdjacencyMatrix(Map<String, Set<Var>> bgp, Map<String, Set<String>> graph, List<String> jobs, Set<Var> allVars) {
        Set<String> edges;
        Set<Var> v2, v1;
    ...
    private void bfsSearch(String root, Map<String, Set<String>> graph, List<String> path, int depth) {
